    ...
    <div className="flex flex-col bg-carbon pb-24">
      ...
      <section className="relative min-h-[calc(100vh-4rem)] flex items-center overflow-hidden bg-carbon">
          ...
          <div className="flex flex-col justify-between h-full lg:h-auto text-left animate-hit max-w-2xl mx-auto lg:mx-0 w-full">
            ...
            <div className="space-y-6 mt-8 lg:mt-0">
              ...
              <div className="inline-flex items-center gap-4">
                ...
                <span className="text-tatami-blanco/60 font-body font-medium text-xs sm:text-sm tracking-wider uppercase">
                  Formativo Especializado
                </span>
              </div>
              
              <h1 className="text-6xl sm:text-7xl lg:text-[7.5rem] font-heading text-tatami-blanco leading-[0.9] tracking-tight uppercase">
                ENTRENA.<br/>
                COMPITE.<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-br from-rojo-impacto to-[#8B0000] drop-shadow-md">GANA.</span>
              </h1>

              <p className="hidden sm:block text-base sm:text-lg text-tatami-blanco/60 font-body max-w-xl leading-relaxed mt-4">
                Disciplina, fuerza y humildad. Tu mejor versión empieza en el tatami de <strong className="text-tatami-blanco/90 font-medium">Najera's Team Central</strong>.
              </p>
            </div>
            ...
            <div className="pt-10 pb-6 lg:pb-0 mt-auto lg:mt-10 flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
              <Link
                ...
                className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-b from-[#D62828] to-[#A61019] rounded-2xl font-body font-medium text-sm tracking-wide text-tatami-blanco transition-all duration-300 shadow-lg shadow-rojo-impacto/20 hover:shadow-xl hover:shadow-rojo-impacto/30 hover:-translate-y-1 overflow-hidden"
              >
                ...
                <span className="relative z-10 drop-shadow-sm">Más Información</span>
        ...
        <div className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center z-20">
          <button
            ...
            className={`transition-opacity duration-500 text-dorado-campeon/50 hover:text-dorado-campeon animate-bounce p-2 bg-white/5 rounded-full backdrop-blur-sm ${showScrollArrow ? 'opacity-100' : 'opacity-0'}`}
          >
            <ChevronDown size={28} />
          </button>
        </div>
      ...
      <section id="welcome-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <h2 className="text-4xl sm:text-5xl font-heading text-tatami-blanco leading-tight tracking-tight">
              Bienvenido a <br/>
              <span className="text-dorado-campeon">Najera's Team</span>
            </h2>
            <div className="h-[2px] w-16 bg-dorado-campeon/50 rounded-full"></div>
            <p className="text-base text-tatami-blanco/70 font-body leading-relaxed">
            ...
            <div>
              <Link
                to="/quienes-somos"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white/[0.03] border border-dorado-campeon/20 rounded-xl hover:border-dorado-campeon/50 text-dorado-campeon font-body font-medium text-sm tracking-wide transition-all duration-300 hover:bg-dorado-campeon/10 hover:shadow-lg hover:shadow-dorado-campeon/10 hover:-translate-y-0.5"
              >
                Nuestro Manifiesto
              </Link>
            </div>
            ...
            {quickAccessCards.map((card, idx) => {
              ...
              return (
                <Link
                  key={idx}
                  to={card.path}
                  className="group bg-white/[0.02] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-center text-center transition-all duration-300 shadow-md hover:shadow-xl hover:shadow-dorado-campeon/10 hover:border-dorado-campeon/30 hover:-translate-y-1.5 relative overflow-hidden backdrop-blur-sm"
                >
                  <div className="absolute inset-0 bg-gradient-to-b from-dorado-campeon/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  
                  <div className="mb-4 text-dorado-campeon/60 group-hover:text-dorado-campeon group-hover:scale-110 transition-transform duration-300 relative z-10">
                    <IconComp className="w-10 h-10" />
                  </div>
                  <span className="font-heading text-sm text-tatami-blanco/90 group-hover:text-tatami-blanco tracking-wide leading-tight relative z-10 transition-colors">
                    {card.title}
                  </span>
                </Link>
              );
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 pt-24 lg:pt-32 w-full">
        <div className="space-y-4 text-center max-w-3xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-heading text-tatami-blanco tracking-tight">
            Servicios <span className="text-rojo-impacto">Especializados</span>
          </h2>
          <div className="h-[2px] w-24 bg-dorado-campeon/50 rounded-full mx-auto"></div>
          <p className="text-sm font-body text-dorado-campeon/70 font-medium tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((srv, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 flex flex-col justify-between group transition-all duration-300 shadow-md hover:shadow-xl hover:shadow-dorado-campeon/5 hover:border-dorado-campeon/20 hover:-translate-y-1.5 relative overflow-hidden backdrop-blur-sm"
              >
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-dorado-campeon/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                
                <div className="space-y-5 relative z-10">
                  <div className="w-12 h-12 bg-white/[0.03] border border-dorado-campeon/20 rounded-xl flex items-center justify-center text-dorado-campeon/80 group-hover:text-dorado-campeon group-hover:border-dorado-campeon group-hover:scale-105 transition-all duration-300 shadow-sm">
                    <SrvIcon size={24} strokeWidth={1.5} />
                  </div>
                  
                  <h3 className="text-xl font-heading text-tatami-blanco tracking-wide leading-tight group-hover:text-dorado-campeon transition-colors">
                    {srv.title}
                  </h3>
